...
**Lições:** A Integration Tax (imposto de integração) aparece quando você otimiza uma métrica sem considerar o ambiente. O modelo funcionava tecnicamente, mas ignorava o impacto nos parceiros.
