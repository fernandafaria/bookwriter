...
Era uma terça-feira de março de 2025, e Maria Silva, PM sênior no Nubank, estava apresentando o dashboard do modelo de detecção de fraude. O slide mostrava números impressionantes: *accuracy* de 99,2%, *precision* de 97,8%, *recall* de 94,5%.
...
Essa pergunta veio de um diretor de produto de um banco digital, durante uma mentoria em 2025. Ele tinha razão em se preocupar. A pesquisa da McKinsey "The State of AI in 2026" mostra que apenas 15% das empresas conseguem conectar métricas de modelo a resultados de negócio (McKinsey & Company, "The State of AI in 2026", janeiro de 2026). O resto está no escuro.
...
Aqui vai o *framework* que criei para resolver esse problema. Chama-se **Decide**, as 5 dimensões para avaliar o verdadeiro custo e ROI de um produto de IA. (Nota: o primeiro "D" é Discovery Cost; o segundo "E" é Exit Cost. Sim, as letras se repetem porque os conceitos são distintos e igualmente importantes.)
...
Fonte: Stat News, "IBM's Watson recommended 'unsafe and incorrect' cancer treatments", julho 2018; The Wall Street Journal, "IBM's Watson Health Struggles With Data, Doctors", 2021; STAT News, "IBM's Watson Health is over. What's next?", 2022.
...
### Primeiros 30 dias: Diagnóstico e Discovery Cost
...
### Próximos 30 dias: Evaluation Gap e Confidence Debt
...
### Últimos 30 dias: Integration Tax, Decision Latency e Exit Cost
...
Com o *framework* Decide, você tem um mapa para navegar esse terreno. *Discovery Cost*, *Evaluation Gap*, *Confidence Debt*, *Integration Tax*, *Decision Latency* e *Exit Cost* são as dimensões que separam um produto de IA que gera valor de um que só gera custo.
