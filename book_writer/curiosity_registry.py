...
CURIOSITY_REGISTRY: list[CuriosityGap] = [
    ...
    CuriosityGap(
        id="gap-team-no-heroes",
        question="Como montar um time de IA que não depende de heróis individuais?",
        planted_in=7,
        resolved_in=8,
        gap_type="medium",
        status="planted",
    ...
    CuriosityGap(
        id="gap-agents-culture",
        question="Com agentes de IA no time, o que acontece com a cultura de produto? A confiança, a colaboração e a autonomia mudam?",
        planted_in=8,
        resolved_in=10,
        gap_type="medium",
        status="planted",
    ...
    CuriosityGap(
        id="gap-pm-junior-agents",
        question="Se um agente pode escrever PRDs melhores que um PM junior, qual o novo papel de entrada na carreira de produto?",
        planted_in=8,
        resolved_in=12,
        gap_type="long",
        status="planted",
