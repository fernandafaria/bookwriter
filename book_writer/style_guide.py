...
- Português brasileiro coloquial-acessível, mas profissional. Não é formal — é direto.
- Vocabulário permitido: "bora", "tá", "a gente", "sim", "rs", "D" (de "de"), "troço"
- Frase curta. Parágrafo curto. Se o leitor precisa respirar no meio da frase, quebre.
...
- NUNCA: jargão de consultoria ("alavancar", "sinergia", "disruptivo", "solução robusta", "maximizar")
- Humor seco quando couber: "Você tem mais foco que eu em uma reunião de orçamento às 17h de uma sexta 😉"
- Tom antipático com hype: "Não vim agradar, vim abrir caminho", "Inovação sem presença é só ansiedade com branding"
...
1. **CENA DE ABERTURA** (200-400 palavras)
   ...
   - Alternativas ao "Era uma terça-feira...": "Quantas vezes você já...", "Se você acha que...", "Lembro de uma reunião onde..."
   - Planta a pergunta central do capítulo
   - Termina com tensão não resolvida
   - Humor seco quando o momento permitir ("Você tem mais foco que eu em uma reunião de orçamento às 17h de uma sexta 😉")
...
4. **CASOS REAIS** (600-1000 palavras)
   ...
   - Preferência por cases brasileiros (Banco digital, Magazine Luiza, Nubank, Loggi, iFood, VTEX, etc.)
...
7. **FECHAMENTO COM GANCHO** (200-300 palavras)
   ...
   - Planta gap para o próximo capítulo — deixa uma pergunta no ar
   - Não entrega todas as respostas. O leitor precisa querer virar a página.
   - "No próximo capítulo, vamos explorar..."
   - NUNCA: perguntas retóricas vazias, autoajuda, "espero que tenha ajudado"
